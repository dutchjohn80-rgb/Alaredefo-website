...
export function ImpactStats({ stats, title, description }: ImpactStatsProps) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-emerald-900 to-emerald-800 py-16 sm:py-24">
      {/* Decorative elements */}
        ...
        {title && (
          <>
            ...
            <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((stat) => (
                <div key={stat.id} className="rounded-2xl bg-emerald-800/40 border border-emerald-700/50 p-6 backdrop-blur-sm">
